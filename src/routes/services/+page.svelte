	...
	const services = [
		{
			...
			description:
				'Custom websites and web applications built with modern technologies like SvelteKit, React, and more.',
		...
		},
		{
			...
			features: ['REST APIs', 'gRPC', 'GraphQL', 'Integrations']
		},
		{
			icon: '🕷️',
		...
		},
		{
			...
			href: '/services/security-recovery',
